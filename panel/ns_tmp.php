        ...
        backdrop: `
          ...
          no-repeat ` 
            ...
            if (result.isConfirmed) {
                  ...
                  window.location.href ="./updatesurvey.php?id="<?php echo $row['id']?>"&title="<?php echo $row['title']?>"&start_date="<?php echo $row['start_date']?>"&end_date="<?php echo $row['end_date']?>"&description="<?php echo $row['description']?>;
               };
        })  
