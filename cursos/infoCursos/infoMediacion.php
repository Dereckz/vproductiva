...
<html>
    <head>
        ...
        <title>Mediación y arbitraje</title>
    </head>
    <body>
    <section id="header">
  ...
  <!-- End Header -->
    ...
    <h1 id="tituloprincipal">MEDIACIÓN Y ARBITRAJE</h1>
    <table  id=tablarecursos>
        <tr>
            <td id="imagentemario"><img src="img/mediacion.png" id="imagentemar"></td>
            <td class="celdatop">
            <table id=tablacontenido>
                <tr> <td></td><td> <h3 id="descricpiontemario">
                Este curso impactará para ser solucionador de problemas efectivos y contribuir a la resolución de conflictos de manera pacífica y justa. Estas habilidades pueden ser valiosas tanto en el ámbito profesional como en la vida cotidiana.
                </br>"Optimiza tus habilidades para tomar decisiones imparciales y justas."
                </h3> </td></tr>
                ...
                INNER JOIN modulo m ON c.iIdCurso = m.fkiIdCurso WHERE c.iIdCurso=20");
                $modulo=0;
                $idcurso="";
