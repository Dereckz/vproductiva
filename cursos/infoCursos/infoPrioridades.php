...
<html>
    <head>
        ...
        <title>Prioridades de alta dirección</title>
    </head>
    <body>
    <section id="header">
  ...
  <!-- End Header -->
    ...
    <h1 id="tituloprincipal">PRIORIDADES DE ALTA DIRECCIÓN</h1>
    <table  id=tablarecursos>
        <tr>
            <td id="imagentemario"><img src="img/prioridades.png" id="imagentemar"></td>
            <td class="celdatop">
            <table id=tablacontenido>
                <tr> <td></td><td> <h3 id="descricpiontemario">
                Este curso está diseñado para líderes y altos directivos que enfrentan constantes desafíos para establecer prioridades efectivas en un entorno empresarial cambiante. Se centra en desarrollar habilidades estratégicas y gerenciales para identificar y ejecutar las prioridades más relevantes y cruciales para el éxito organizacional.
                </br>"Dirige con impacto. Aprende a identificar y enfocarte en lo que realmente importa para tu empresa"
                </h3> </td></tr>
