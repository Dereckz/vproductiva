...
<html>
    <head>
        ...
        <title>Metodologías del Trabajo</title>
    </head>
    <body>
    <section id="header">
  ...
  <!-- End Header -->
    ...
    <h1 id="tituloprincipal">Metodologías del trabajo</h1>
    <table  id=tablarecursos>
        <tr>
            <td id="imagentemario"><img src="img/metodologias.png" id="imagentemar"></td>
            <td class="celdatop">
            <table id=tablacontenido>
                <tr> <td></td><td> <h3 id="descricpiontemario">
                Nuestro curso te ayudará a dotarte de herramientas y estrategias necesarias para transformar tu enfoque laboral, a través de la adopción de metodologías efectivas, aprenderás a gestionar tu tiempo de manera eficiente, mejorar tu productividad, y enfrentar los desafíos laborales con confianza.
                </br>"Transforma tus desafíos laborales en oportunidades de crecimiento.”
                </h3> </td></tr>
                ...
                INNER JOIN modulo m ON c.iIdCurso = m.fkiIdCurso WHERE c.iIdCurso=11");
                $modulo=0;
                $idcurso="";
