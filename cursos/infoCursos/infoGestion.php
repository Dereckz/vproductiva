...
<html>
  ...
  <!-- End Header -->
    ...
    <h1 id="tituloprincipal">GESTIÓN DE CAMBIOS</h1>
    <table  id=tablarecursos>
        <tr>
            <td id="imagentemario"><img src="img/gestion.png" id="imagentemar"></td>
            <td class="celdatop">
            <table id=tablacontenido>
                <tr> <td></td><td> <h3 id="descricpiontemario">
                Este curso de Gestión del Cambio proporciona a los participantes las habilidades y el conocimiento necesarios para liderar transformaciones organizacionales exitosas, minimizando la resistencia al cambio y maximizando la adopción efectiva de nuevas prácticas y procesos.
                </br>"Prepárate para el futuro: el cambio es tu aliado, y la Gestión del Cambio tu herramienta."
                </h3> </td></tr>
                ...
                INNER JOIN modulo m ON c.iIdCurso = m.fkiIdCurso WHERE c.iIdCurso=10");
                $modulo=0;
                $idcurso="";
