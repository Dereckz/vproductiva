...
<html>
    <head>
        ...
        <title>Los derechos humanos en las relaciones laborales</title>
    </head>
    <body>
    <section id="header">
  ...
  <!-- End Header -->
    ...
    <h1 id="tituloprincipal">LOS DERECHOS HUMANOS EN RELACIONES LABORALES</h1>
    <table  id=tablarecursos>
        <tr>
            <td id="imagentemario"><img src="img/humanos.png" id="imagentemar"></td>
            <td class="celdatop">
            <table id=tablacontenido>
                <tr> <td></td><td> <h3 id="descricpiontemario">
                Tomar este curso sobre derechos humanos en las relaciones laborales te ayudará a tener un impacto transformador para empoderarte y crear un entorno laboral más justo y respetuoso. Además, puede beneficiar a tu empresa a reducir los riesgos legales, mejorar la cultura organizacional y fortalecer su reputación.
                </br>"Empodera a los líderes para promover un entorno de trabajo respetuoso."
                </h3> </td></tr>
                ...
                INNER JOIN modulo m ON c.iIdCurso = m.fkiIdCurso WHERE c.iIdCurso=19");
                $modulo=0;
                $idcurso="";
