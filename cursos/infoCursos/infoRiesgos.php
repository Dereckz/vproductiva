...
<html>
  ...
  <!-- End Header -->
    ...
    <h1 id="tituloprincipal">RIESGOS LABORALES</h1>
    <table  id=tablarecursos>
        <tr>
            <td id="imagentemario"><img src="img/riesgos.png" id="imagentemar"></td>
            <td class="celdatop">
            <table id=tablacontenido>
                <tr> <td></td><td> <h3 id="descricpiontemario">
                Este curso está diseñado para ofrecerte un profundo entendimiento sobre los riesgos laborales y cómo gestionarlos de manera efectiva en el entorno laboral. Te proporcionará las herramientas y conocimientos necesarios para identificar, evaluar y mitigar los riesgos inherentes a diversas actividades laborales, promoviendo un ambiente de trabajo seguro y saludable.
                </br>"Conocer los riesgos es el primer paso para evitarlos”
                </h3> </td></tr>
                ...
                INNER JOIN modulo m ON c.iIdCurso = m.fkiIdCurso WHERE c.iIdCurso=14");
                $modulo=0;
                $idcurso="";
