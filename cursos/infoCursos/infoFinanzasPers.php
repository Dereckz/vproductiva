...
<html>
  ...
  <!-- End Header -->
    ...
    <h1 id="tituloprincipal">FINANZAS PERSONALES</h1>
    <table  id=tablarecursos>
        <tr>
            <td id="imagentemario"><img src="img/fpersonales.png" id="imagentemar"></td>
            <td class="celdatop">
            <table id=tablacontenido>
                <tr> <td></td><td> <h3 id="descricpiontemario">
                Los participantes adquieren una comprensión más sólida de conceptos financieros, incluyendo presupuestos, ahorros, inversiones, deudas y planificación para el futuro. Aprenderán a tomar decisiones financieras más informadas y estratégicas, lo que puede conducir a una mejor administración de sus recursos y una reducción de las deudas.
                </br>"Mejora tus habilidades financieras y abre puertas a nuevas oportunidades, con la bue a toma de decisiones”
                </h3> </td></tr>
                ...
                INNER JOIN modulo m ON c.iIdCurso = m.fkiIdCurso WHERE c.iIdCurso=22");
                $modulo=0;
                $idcurso="";
