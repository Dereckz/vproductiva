...
<html>
  ...
  <!-- End Header -->
    ...
    <h1 id="tituloprincipal">SEGURIDAD E HIGIENE EN LAS EMPRESAS</h1>
    <table  id=tablarecursos>
        <tr>
            <td id="imagentemario"><img src="img/seguridad.png" id="imagentemar"></td>
            <td class="celdatop">
            <table id=tablacontenido>
                <tr> <td></td><td> <h3 id="descricpiontemario">
                Este curso ofrece una inmersión completa en los principios fundamentales de seguridad e higiene en el entorno laboral. Diseñado para profesionales comprometidos con la salud y seguridad de su equipo, proporciona los conocimientos esenciales y las herramientas prácticas necesarias para prevenir accidentes, enfermedades laborales y promover un entorno de trabajo más saludable.
                </br>"Haz de la seguridad una prioridad: nuestro curso te proporcionará las herramientas necesarias para crear un entorno laboral seguro y productivo."
                </h3> </td></tr>
