...
<html>
    <head>
        ...
        <title>Derechos y obligaciones como empleados</title>
    </head>
    <body>
    <section id="header">
  ...
  <!-- End Header -->
    ...
    <h1 id="tituloprincipal">DERECHOS Y OBLIGACIONES COMO EMPLEADOS</h1>
    <table  id=tablarecursos>
        <tr>
            <td id="imagentemario"><img src="img/derechos.png" id="imagentemar"></td>
            <td class="celdatop">
            <table id=tablacontenido>
                <tr> <td></td><td> <h3 id="descricpiontemario">
                Tomar este curso, te garantiza tener un impacto positivo como colaborador y como empleador. Tendrás, conciencia de derechos y responsabilidades, mejorarás la relación empleado-empleador, sabrás sobre el cumplimiento legal de las leyes laborales, mejorarás tu ambiente de trabajo, tendrás mayor productividad, reducirás los conflictos, obtendrás mayor retención del talento humano de tu organización e impulsarán a tu equipo de trabajo a dar lo mejor de sí.
                </br>"Aprende a proteger tus derechos y alcanzar éxito en el trabajo"
                </h3> </td></tr>
                ...
                INNER JOIN modulo m ON c.iIdCurso = m.fkiIdCurso WHERE c.iIdCurso=16");
                $modulo=0;
                $idcurso="";
