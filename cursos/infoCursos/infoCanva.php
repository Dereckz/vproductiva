...
<html>
  ...
  <!-- End Header -->
    ...
    <h1 id="tituloprincipal">CANVA</h1>
    <table  id=tablarecursos>
        <tr>
            <td id="imagentemario"><img src="img/canva.png" id="imagentemar"></td>
            <td class="celdatop">
            <table id=tablacontenido>
                <tr> <td></td><td> <h3 id="descricpiontemario">
                Este curso introductorio a Canva te enseñará desde lo más básico hasta las técnicas avanzadas de diseño para obtener las habilidades necesarias para perfeccionar tus creaciones con herramientas de edición de primera categoría, plantillas meticulosamente diseñadas y la capacidad de descargar archivos en formatos clave.
                </br>“Eleva tus diseños con Canva como tu herramienta de diseño y tu creatividad como el diferenciador”
                </h3> </td></tr>
                ...
                INNER JOIN modulo m ON c.iIdCurso = m.fkiIdCurso WHERE c.iIdCurso=26");
                $modulo=0;
                $idcurso="";
