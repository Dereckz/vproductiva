...
<html>
    <head>
        ...
        <title>Salud, Higiene y seguridad</title>
    </head>
    <body>
  ...
  <div>
    ...
    <table id=tablarecursos>
        <tr> <td colspan=3 id=filatitulo> <h2>Curso de Salud, Higiene y Seguridad</h2> </td></tr>    
...
if($numMudulo==$numVisto){
    $constancia='<tr><td><a href="../alumno/reconocimiento.php?curso=SALUD, HIGIENE Y SEGURIDAD&idCurso=5" id="" target="_blank" class="u-border-1 u-border-active-grey-70 u-border-black u-border-hover-grey-70 u-border-no-left u-border-no-right u-border-no-top u-bottom-left-radius-0 u-bottom-right-radius-0 u-btn u-button-style u-custom-item u-none u-radius-0 u-text-active-palette-2-base u-text-body-color u-text-hover-palette-2-base u-top-left-radius-0 u-top-right-radius-0 u-btn-2">Generar constancia<br></a></td></tr>';
