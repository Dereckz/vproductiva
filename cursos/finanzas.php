...
WHERE c.iIdCurso=6 and v.idAlumno=" . $_SESSION["id"]." GROUP BY iIdRecurso");
...
$info =mysqli_fetch_array($check);
     ...
     echo '<tr> <td class=iconorecursocelda style="width: 5em;"><img class=iconorecurso src="img/recursovideo.png"></td> <td class=fondotemario><a class=titulostemario  href="'.$consulta['cRuta'].'" id="'.$consulta['iIdRecurso'].'" target="_blank" class="u-border-1 u-border-active-grey-70 u-border-black u-border-hover-grey-70 u-border-no-left u-border-no-right u-border-no-top u-bottom-left-radius-0 u-bottom-right-radius-0 u-btn u-button-style u-custom-item u-none u-radius-0 u-text-active-palette-2-base u-text-body-color u-text-hover-palette-2-base u-top-left-radius-0 u-top-right-radius-0 u-btn-2">'.$consulta['cNombreModulo'].'</a></td> '.$visto.' </tr>
