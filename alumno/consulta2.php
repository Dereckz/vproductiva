...
function infoCurso2($idarea )
{
   ...
   while ($consulta = mysqli_fetch_array($resultado)) {
    $ruta=$consulta["ruta"];
       ...
       $link ='<div style="text-align: center; background-color: #00b0ff; border-radius: 25em;">
       ...
       <div style="text-align: center;"><a href="' . $ruta. '" class="u-border-1 u-border-active-grey-70 u-border-black u-border-hover-grey-70 u-border-no-left u-border-no-right u-border-no-top u-bottom-left-radius-0 u-bottom-right-radius-0 u-btn u-button-style u-custom-item u-none u-radius-0 u-text-active-palette-2-base u-text-body-color u-text-hover-palette-2-base u-top-left-radius-0 u-top-right-radius-0 u-btn-2">Ver temario del curso<br></a></div>
       '.$link.'
